    ...
    public static final class QuorumCert extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.bsnbase.sdk.util.pb.Chainedbft.QuorumCert.class) {
                            if (PARSER == null) {
    ...
    public static final class QCSignInfos extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.bsnbase.sdk.util.pb.Chainedbft.QCSignInfos.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class SignInfo extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.bsnbase.sdk.util.pb.Chainedbft.SignInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class ChainedBftPhaseMessage extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.bsnbase.sdk.util.pb.Chainedbft.ChainedBftPhaseMessage.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class ChainedBftVoteMessage extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.bsnbase.sdk.util.pb.Chainedbft.ChainedBftVoteMessage.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
