...
public class HttpsService<T extends Object & IBody, K extends Object & IBody> {
    ...
    private String doHttpsPost(@NotNull BaseReqModel<T> req, String url, String cert) throws Exception {
